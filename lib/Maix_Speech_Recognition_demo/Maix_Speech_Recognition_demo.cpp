...
int
SpeechRecognizer::begin(int pin1, int pin2, int pin3)
{
    //io_mux_init
    fpioa_set_function(pin1, FUNC_I2S0_IN_D0);
    fpioa_set_function(pin2, FUNC_I2S0_SCLK);
    fpioa_set_function(pin3, FUNC_I2S0_WS);
